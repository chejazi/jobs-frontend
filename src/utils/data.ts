...
const tokenImages: StringMap = {
  ...
  '0x50c5725949a6f0c72e6c4a641f24049a917db0cb': '/tokens/dai.png',
  ...
  '0x8C9037D1Ef5c6D1f6816278C7AAF5491d24CD527': '/tokens/moxie.webp',
  ...
  '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913': '/tokens/usdc.png',
...
export const evmEmptyListingArray = () => [[],[],[],[],[],[],[],[]] as RawListingArray;
export const evmEmptyListing = () => ([
  '',
  '',
...
export const evm2Listing = (res: RawListing) => {
  return {
    title: res[0],
    description: res[1],
    manager: res[2] as Address,
    token: res[3] as Address,
    quantity: res[4],
    duration: Number(res[5]),
    createTime: Number(res[6]),
    status: Number(res[7]),
  } as Listing
};
